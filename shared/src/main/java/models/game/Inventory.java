...
public class Inventory implements Serializable {
    ...
    public boolean toolEquip(Player player, String toolName){
        for(Item item : items) {
    ...
    public ArrayList<String> showAvailableTools(Player player){
        ArrayList<String> output = new ArrayList<>();
        output.add(player.getUser().getUsername() + "'s Available Tools:");
        for(Item item : items) {
